...
for (i in seq_along(plots)) {
  ggsave(filename = paste0("../outputs/plot_", i, ".png"), plot = plots[[i]], width = 8, height = 6, dpi = 300)
}
...
# Save the plot
ggsave("../outputs/nCellsWeek.png", plot = plot,
       width = 8, height = 6, dpi = 300)
...
ggsave("../outputs/den_C.png", plot = p, width = 8, height = 6, dpi = 300 )
p
```
...
p <- merged_object@meta.data %>% 
    ...
    theme_classic() +
    scale_x_log10()
ggsave("../outputs/den_F.png", plot = p, width = 8, height = 6, dpi = 300 )
p
```
...
ggsave("../outputs/den_mt.png", plot = p, width = 8, height = 6, dpi = 300 )
p
```
...
ggsave("../outputs/FeaSca_mtF_days.png",
       plot = p,
       width = 12, height = 6, dpi = 300) 
p
```
...
ggsave("../outputs/FeaSca_CF_day.png",
       plot = p,
       width = 12, height = 6, dpi = 300) 
p
```
