...
## Check if every Seurat object has variable features
```{r}
# human4_6W
head(VariableFeatures(human4_6W), 10)  # First 10 HVGs
length(VariableFeatures(human4_6W))    # Total number of HVGs

# human7_11W
head(VariableFeatures(human7_11W), 10)  # First 10 HVGs
length(VariableFeatures(human7_11W))    # Total number of HVGs

# human12_20W
head(VariableFeatures(human12_20W), 10)  # First 10 HVGs
length(VariableFeatures(human12_20W))    # Total number of HVGs
```
...
Cannot run this because there are multiple SCT models in the SCT assay of human12_20W.
Will find variable when do integration.
```{r}
#VariableFeatures(human12_20W) <- SelectIntegrationFeatures(object.list = list(human12_20W), nfeatures = 3000)
