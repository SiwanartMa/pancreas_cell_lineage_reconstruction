...
ggplot(t1, aes(x = Sample, y = Count, fill = Class)) +
  ...
  theme_minimal()
#ggsave("~/Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46_scDbl.png")

# plot distribution of scDblFinder.score
VlnPlot(obj, "scDblFinder.score", group.by = "scDblFinder.class")
#ggsave("~/Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46scDbl_score.png")
...
#ggsave("Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46_mitoVln.png")
...
#ggsave("Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46_riboVln.png")
...
#ggsave("Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46_corr_ribomito.png")
...
#ggsave("./Desktop/researchProject/integration/outputs/QC_plot/4_6PCW_reQC/46_allvln.png")
